namespace DataEdit
{
    ...
    public class UserControlAddData3 : UserControlBase1
    {
        ...
        private const string mClassName = "DataEdit.UserControlAddData3";
        ...
        private IFeatureWorkspace mSelFeatureWorkspace = null;
        ...
        private void DoAdd(ILayer pLayer)
        {
            ...
            {
                this.mErrOpt.ErrorOperate(this.mSubSysName, "DataEdit.UserControlAddData3", "DoAdd", exception.GetHashCode().ToString(), exception.Source, exception.Message, "", "", "");
            }
        }
        ...
        private void EnumDirectories(TreeListNode ParentNode)
        {
            ...
            {
                this.mErrOpt.ErrorOperate(this.mSubSysName, "DataEdit.UserControlAddData3", "EnumDirectories", exception.GetHashCode().ToString(), exception.Source, exception.Message, "", "", "");
            }
        }
        ...
        private void InitialCatalogList()
        {
            ...
            {
                this.mErrOpt.ErrorOperate(this.mSubSysName, "DataEdit.UserControlAddData3", "InitialCatalogList", exception.GetHashCode().ToString(), exception.Source, exception.Message, "", "", "");
            }
        }
        ...
        private void InitialControls()
        {
            ...
            {
                this.mErrOpt.ErrorOperate(this.mSubSysName, "DataEdit.UserControlAddData3", "InitialcListFile", exception.GetHashCode().ToString(), exception.Source, exception.Message, "", "", "");
            }
        }

        private void InitializeComponent()
        {
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(UserControlAddData3));
            ...
            this.groupControl.Size = new System.Drawing.Size(334, 511);
            ...
            this.splitContainerControl1.Size = new System.Drawing.Size(334, 510);
            ...
            this.groupControlCatalog.Controls.Add(this.panel8);
            ...
            this.groupControlCatalog.Size = new System.Drawing.Size(334, 294);
            ...
            this.tListCatalog.Location = new System.Drawing.Point(6, 35);
            ...
            this.tListCatalog.Size = new System.Drawing.Size(322, 185);
            this.tListCatalog.StateImageList = this.imageCollection1;
            ...
            this.labelCatalog.Size = new System.Drawing.Size(322, 31);
            ...
            this.panel5.Size = new System.Drawing.Size(322, 40);
            ...
            this.buttonPath.Location = new System.Drawing.Point(65, 9);
            ...
            this.buttonPath.Size = new System.Drawing.Size(209, 20);
            this.buttonPath.TabIndex = 76;
            // 
            // panel6
            // 
            this.panel6.Dock = System.Windows.Forms.DockStyle.Right;
            this.panel6.Location = new System.Drawing.Point(274, 9);
            ...
            this.simpleButtonRefrash.Location = new System.Drawing.Point(280, 9);
            ...
            this.panel8.Padding = new System.Windows.Forms.Padding(0, 0, 0, 6);
            ...
            this.simpleButtonViewMap3.Location = new System.Drawing.Point(196, 0);
            this.simpleButtonViewMap3.Name = "simpleButtonViewMap3";
            this.simpleButtonViewMap3.Size = new System.Drawing.Size(60, 28);
            ...
            this.panel9.Size = new System.Drawing.Size(6, 28);
            ...
            this.simpleButtonSelect.Location = new System.Drawing.Point(262, 0);
            this.simpleButtonSelect.Name = "simpleButtonSelect";
            this.simpleButtonSelect.Size = new System.Drawing.Size(60, 28);
            ...
            this.groupControlNOList.Size = new System.Drawing.Size(334, 211);
            ...
            this.panel7.Location = new System.Drawing.Point(6, 31);
            this.panel7.Name = "panel7";
            this.panel7.Padding = new System.Windows.Forms.Padding(0, 0, 0, 5);
            this.panel7.Size = new System.Drawing.Size(322, 180);
            ...
            this.treeListno.Size = new System.Drawing.Size(322, 175);
            ...
            this.labelLocation.Size = new System.Drawing.Size(334, 30);
            this.labelLocation.TabIndex = 21;
            this.labelLocation.Text = "      添加数据          ";
            ...
            this.Name = "UserControlAddData3";
            this.Padding = new System.Windows.Forms.Padding(0, 0, 6, 6);
            this.Size = new System.Drawing.Size(340, 547);
        ...
        public void InitialValue(IBasicMap map, IGroupLayer glayer, FormAddData3 form, bool bAddFlag, IFeatureLayer player)
        {
            try
            {
                this.mBasicMap = map;
            ...
            {
                this.mErrOpt.ErrorOperate(this.mSubSysName, "DataEdit.UserControlAddData3", "InitialValue", exception.GetHashCode().ToString(), exception.Source, exception.Message, "", "", "");
            }
        }
        ...
        private void simpleButtonSelect_Click(object sender, EventArgs e)
        {
            ...
            {
                this.pareForm.fWorkspace = null;
                this.pareForm.cancelflag = true;
                this.pareForm.Close();
            }
        }
        ...
        private void simpleButtonViewMap3_Click(object sender, EventArgs e)
        {
            ...
            {
                this.pareForm.fWorkspace = this.mSelFeatureWorkspace;
                this.pareForm.cancelflag = false;
                this.pareForm.Close();
            }
        }
        ...
        private void splitContainerControl1_Resize(object sender, EventArgs e)
        {
            ...
            {
                this.splitContainerControl1.SplitterPosition = (this.splitContainerControl1.Width * 2) / 3;
            }
            else
            {
                this.splitContainerControl1.SplitterPosition = (this.splitContainerControl1.Height * 2) / 3;
            }
        }
        ...
        private void tListCatalog_MouseUp(object sender, MouseEventArgs e)
        {
            try
            {
                ...
                if (this.tListCatalog.FocusedNode != null)
                {
                    ...
                    try
                    {
                        if (this.tListCatalog.FocusedNode.Tag is string)
                        {
                            Directory.SetCurrentDirectory(this.tListCatalog.FocusedNode.Tag.ToString());
                            currentDirectory = Directory.GetCurrentDirectory();
                        }
                        else if (this.tListCatalog.FocusedNode.Tag is IFeatureWorkspace)
                        {
                            this.buttonPath.Text = Directory.GetCurrentDirectory() + @"\" + this.tListCatalog.FocusedNode.GetValue(0);
                            this.mSelFeatureWorkspace = this.tListCatalog.FocusedNode.Tag as IFeatureWorkspace;
                            this.pareForm.fWorkspace = this.mSelFeatureWorkspace;
            ...
            {
                this.mErrOpt.ErrorOperate(this.mSubSysName, "DataEdit.UserControlAddData3", "tListCatalog_MouseUp", exception.GetHashCode().ToString(), exception.Source, exception.Message, "", "", "");
                this.Cursor = Cursors.Default;
            }
        }
        ...
        private void treeListno_MouseUp(object sender, MouseEventArgs e)
        {
            ...
            {
                this.mErrOpt.ErrorOperate(this.mSubSysName, "DataEdit.UserControlAddData3", "treeListno_MouseUp", exception.GetHashCode().ToString(), exception.Source, exception.Message, "", "", "");
            }
        }
        ...
        public bool CancelVisible
        {
            ...
            set
            {
                ...
                {
                    MessageBox.Show(exception.Message, "DataEdit.UserControlAddData3", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                }
            }
        }
