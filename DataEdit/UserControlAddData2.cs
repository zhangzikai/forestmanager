namespace DataEdit
{
    ...
    public class UserControlAddData2 : UserControlBase1
    {
        ...
        private const string mClassName = "DataEdit.UserControlAddData2";
        ...
        private void AddLayer(TreeList treeList)
        {
            ...
            {
                this.mErrOpt.ErrorOperate(this.mSubSysName, "DataEdit.UserControlAddData2", "AddLayer", exception.GetHashCode().ToString(), exception.Source, exception.Message, "", "", "");
            }
        }
        ...
        private void DoAdd(ILayer pLayer)
        {
            ...
            {
                this.mErrOpt.ErrorOperate(this.mSubSysName, "DataEdit.UserControlAddData2", "DoAdd", exception.GetHashCode().ToString(), exception.Source, exception.Message, "", "", "");
            }
        }
        ...
        private void EnumDirectories(TreeListNode ParentNode)
        {
            ...
            {
                this.mErrOpt.ErrorOperate(this.mSubSysName, "DataEdit.UserControlAddData2", "EnumDirectories", exception.GetHashCode().ToString(), exception.Source, exception.Message, "", "", "");
            }
        }
        ...
        private void InitialCatalogList()
        {
            ...
            {
                this.mErrOpt.ErrorOperate(this.mSubSysName, "DataEdit.UserControlAddData2", "InitialCatalogList", exception.GetHashCode().ToString(), exception.Source, exception.Message, "", "", "");
            }
        }
        ...
        private void InitialControls()
        {
            ...
            {
                this.mErrOpt.ErrorOperate(this.mSubSysName, "DataEdit.UserControlAddData2", "InitialcListFile", exception.GetHashCode().ToString(), exception.Source, exception.Message, "", "", "");
            }
        }

        private void InitializeComponent()
        {
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(UserControlAddData2));
            ...
            this.groupControl.Size = new System.Drawing.Size(340, 517);
            ...
            this.splitContainerControl1.Size = new System.Drawing.Size(340, 516);
            ...
            this.groupControlCatalog.Size = new System.Drawing.Size(340, 294);
            ...
            this.tListCatalog.Size = new System.Drawing.Size(328, 219);
            this.tListCatalog.StateImageList = this.imageCollection1;
            ...
            this.labelCatalog.Size = new System.Drawing.Size(328, 31);
            ...
            this.buttonPath.Size = new System.Drawing.Size(215, 20);
            this.buttonPath.TabIndex = 76;
            // 
            // panel6
            // 
            this.panel6.Dock = System.Windows.Forms.DockStyle.Right;
            this.panel6.Location = new System.Drawing.Point(280, 9);
            ...
            this.simpleButtonRefrash.Location = new System.Drawing.Point(286, 9);
            ...
            this.groupControlNOList.Size = new System.Drawing.Size(340, 217);
            ...
            this.panel7.Padding = new System.Windows.Forms.Padding(0, 0, 0, 6);
            this.panel7.Size = new System.Drawing.Size(328, 186);
            ...
            this.treeListno.Size = new System.Drawing.Size(328, 146);
            ...
            this.panel8.Padding = new System.Windows.Forms.Padding(0, 7, 0, 0);
            ...
            this.simpleButtonViewMap3.Location = new System.Drawing.Point(202, 7);
            this.simpleButtonViewMap3.Name = "simpleButtonViewMap3";
            this.simpleButtonViewMap3.Size = new System.Drawing.Size(60, 27);
            ...
            this.panel9.Location = new System.Drawing.Point(262, 7);
            this.panel9.Name = "panel9";
            this.panel9.Size = new System.Drawing.Size(6, 27);
            ...
            this.simpleButtonSelect.Location = new System.Drawing.Point(268, 7);
            this.simpleButtonSelect.Name = "simpleButtonSelect";
            this.simpleButtonSelect.Size = new System.Drawing.Size(60, 27);
            ...
            this.labelLocation.Size = new System.Drawing.Size(340, 30);
        ...
        public void InitialValue(IBasicMap map, IGroupLayer glayer, FormAddData2 form, bool bAddFlag, IFeatureLayer player)
        {
            try
            {
                this.mBasicMap = map;
            ...
            {
                this.mErrOpt.ErrorOperate(this.mSubSysName, "DataEdit.UserControlAddData2", "InitialValue", exception.GetHashCode().ToString(), exception.Source, exception.Message, "", "", "");
            }
        }
        ...
        private void tListCatalog_MouseUp(object sender, MouseEventArgs e)
        {
            ...
            {
                this.mErrOpt.ErrorOperate(this.mSubSysName, "DataEdit.UserControlAddData2", "tListCatalog_MouseUp", exception.GetHashCode().ToString(), exception.Source, exception.Message, "", "", "");
                this.Cursor = Cursors.Default;
            }
        }
        ...
        private void treeListno_MouseUp(object sender, MouseEventArgs e)
        {
            ...
            {
                this.mErrOpt.ErrorOperate(this.mSubSysName, "DataEdit.UserControlAddData2", "treeListno_MouseUp", exception.GetHashCode().ToString(), exception.Source, exception.Message, "", "", "");
            }
        }
        ...
        public bool CancelVisible
        {
            ...
            set
            {
                ...
                {
                    MessageBox.Show(exception.Message, "DataEdit.UserControlAddData2", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                }
            }
        }
