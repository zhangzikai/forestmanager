namespace Cartography.Render
{
    ...
    public class UniqueRender : FormBase3
    {
        ...
        private const string mClassName = "Cartography.Element.UniqueRender";
        ...
        public UniqueRender(IFeatureLayer pFeatureLayer)
        {
        ...
        private void advBandedGridView1_CellValueChanged(object sender, CellValueChangedEventArgs e)
        {
            ...
            {
                this.mErrOpt.ErrorOperate(this.mSubSysName, "Cartography.Element.UniqueRender", "advBandedGridView1_CellValueChanged", exception.GetHashCode().ToString(), exception.Source, exception.Message, "", "", "");
            }
        }
        ...
        private void advBandedGridView1_SelectionChanged(object sender, SelectionChangedEventArgs e)
        {
            ...
            {
                this.mErrOpt.ErrorOperate(this.mSubSysName, "Cartography.Element.UniqueRender", "advBandedGridView1_SelectionChanged", exception.GetHashCode().ToString(), exception.Source, exception.Message, "", "", "");
            }
        }
        ...
        private void bbiNiewTitle_ItemClick(object sender, ItemClickEventArgs e)
        {
            ...
            {
                this.mErrOpt.ErrorOperate(this.mSubSysName, "Cartography.Element.UniqueRender", "bbiNiewTitle_ItemClick", exception.GetHashCode().ToString(), exception.Source, exception.Message, "", "", "");
            }
        }
        ...
        private void bbiSymbolPro_ItemClick(object sender, ItemClickEventArgs e)
        {
            ...
            {
                this.mErrOpt.ErrorOperate(this.mSubSysName, "Cartography.Element.UniqueRender", "bbiSymbolPro_ItemClick", exception.GetHashCode().ToString(), exception.Source, exception.Message, "", "", "");
            }
        }

        private void btAddOne_Click(object sender, EventArgs e)
        {
            if (this.cbeCartoField.SelectedIndex == -1)
            {
                XtraMessageBox.Show("没有可选字段！");
            }
            else
            {
                try
                {
                    if (this.cbeCartoField.SelectedIndex == 0)
                    {
                        XtraMessageBox.Show("请选择字段！");
                    }
                    else
                    {
                        IField pField = this.fls[this.cbeCartoField.SelectedIndex - 1];
                        AddValue value2 = new AddValue(pField, this._fLayer.FeatureClass as ITable, this._render);
                        if (value2.ShowDialog() == DialogResult.OK)
                        {
                            Dictionary<string, string> codeValues = value2.CodeValues;
                            if (codeValues.Count != 0)
                            {
                                IFieldEdit edit = pField as IFieldEdit;
                                IDomain domain = edit.Domain;
                                ArrayList dataSource = this.gcValue.DataSource as ArrayList;
                                IColorRamp colorRamp = this.GetColorRamp();
                                colorRamp.Size = codeValues.Count;
                                bool ok = false;
                                ...
                                if (ok)
                                {
                                    ...
                                    {
                                        dataSource.Add(new Cartography.Render.Record(null, null, "标题", pField.AliasName, null));
                                        this.refValues.Add("-1");
                                    }
                                    ...
                                    if (domain is ICodedValueDomain)
                                    {
                                        foreach (KeyValuePair<string, string> pair in codeValues)
                                        {
                                            ...
                                            this._render.AddValue(pair.Key, heading, pSymbol);
                                            index++;
                                        }
                                    }
                                    else
                                    {
                                        foreach (KeyValuePair<string, string> pair2 in codeValues)
                                        {
                                            ...
                                            dataSource.Add(new Cartography.Render.Record(null, bitmap2, pair2.Value, pair2.Value, null));
                                            this.refValues.Add(pair2.Value);
                                            this._render.AddValue(pair2.Value, heading, symbol2);
                                            index++;
                                        }
                                    }
                                    this.gcValue.RefreshDataSource();
                ...
                {
                    this.mErrOpt.ErrorOperate(this.mSubSysName, "Cartography.Element.UniqueRender", "btAddOne_Click", exception.GetHashCode().ToString(), exception.Source, exception.Message, "", "", "");
                }
            }
        }
        ...
        private void btAllValue_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                dataSource.Add(new Cartography.Render.Record(null, null, "标题", field.AliasName, null));
                ...
                colorRamp.Size = domain.CodeCount;
                colorRamp.CreateRamp(out ok);
                if (!ok)
                {
                    goto Label_01ED;
                ...
                {
                    string pLabel = domain.get_Name(i);
                    string str2 = domain.get_Value(i).ToString();
                    ISymbol symbol = UniqueValueCarto.SetSymbolByColorRamp(this._fLayer.FeatureClass.ShapeType, colorRamp.get_Color(i));
                    if (symbol == null)
                    {
                        goto Label_01D2;
                    }
                    this._render.AddValue(str2, "标题", symbol);
                    Bitmap pImage = BitmapManager.GetSymbolBitMap(symbol, this.bgcDefBitmap.Width, 30);
                    dataSource.Add(new Cartography.Render.Record(null, pImage, str2, pLabel, null));
                    this._render.set_Label(str2, pLabel);
                    this.refValues.Add(str2);
                }
                goto Label_01DD;
            Label_01D2:
            ...
            Label_01FD:
                ...
                queryFilter.SubFields = field.Name;
            ...
            {
                this.mErrOpt.ErrorOperate(this.mSubSysName, "Cartography.Element.UniqueRender", "btAllValue_Click", exception.GetHashCode().ToString(), exception.Source, exception.Message, "", "", "");
            }
        }
        ...
        private void gcValue_MouseDown(object sender, MouseEventArgs e)
        {
            ...
            {
                this.mErrOpt.ErrorOperate(this.mSubSysName, "Cartography.Element.UniqueRender", "gcValue_MouseDown", exception.GetHashCode().ToString(), exception.Source, exception.Message, "", "", "");
            }
        }
        ...
        private void icbeColorRamp_SelectedIndexChanged(object sender, EventArgs e)
        {
            if (!this.init)
            {
                ...
                {
                    this.mErrOpt.ErrorOperate(this.mSubSysName, "Cartography.Element.UniqueRender", "icbeColorRamp_SelectedIndexChanged", exception.GetHashCode().ToString(), exception.Source, exception.Message, "", "", "");
                }
            }
        }
        ...
        private void Initial()
        {
            ...
            {
                this.mErrOpt.ErrorOperate(this.mSubSysName, "Cartography.Element.UniqueRender", "Initial", exception.GetHashCode().ToString(), exception.Source, exception.Message, "", "", "");
            }
        }
        ...
        private void InitializeComponent()
        {
            ...
            this.gcValue.Location = new System.Drawing.Point(8, 101);
            ...
            this.gcValue.Size = new System.Drawing.Size(430, 320);
            ...
            // btAllValue
            // 
            this.btAllValue.Location = new System.Drawing.Point(8, 68);
            ...
            // btRemoveAll
            // 
            this.btRemoveAll.Location = new System.Drawing.Point(351, 68);
            ...
            // btAddOne
            // 
            this.btAddOne.Location = new System.Drawing.Point(127, 68);
            ...
            // btRemoveOne
            // 
            this.btRemoveOne.Location = new System.Drawing.Point(232, 68);
            ...
            // btOK
            // 
            this.btOK.Location = new System.Drawing.Point(138, 428);
            this.btOK.Name = "btOK";
            ...
            // btCancel
            // 
            this.btCancel.Location = new System.Drawing.Point(267, 428);
            ...
            this.Name = "UniqueRender";
            this.StartPosition = System.Windows.Forms.FormStartPosition.CenterParent;
            this.Text = "唯一值渲染";
            this.Load += new System.EventHandler(this.UniqueRender_Load);
        ...
        private void item_ItemClick(object sender, ItemClickEventArgs e)
        {
            ...
            {
                this.mErrOpt.ErrorOperate(this.mSubSysName, "Cartography.Element.UniqueRender", "item_ItemClick", exception.GetHashCode().ToString(), exception.Source, exception.Message, "", "", "");
            }
        }
        ...
        private void UniqueRender_Load(object sender, EventArgs e)
        {
        }
    }
}
