namespace VgsTiledMap.Ags
{
    ...
    [ProgId("AddSOSOMapCommand"), Guid("5F1469DD-6314-480a-AECE-157A35167D8D"), ClassInterface(ClassInterfaceType.None)]
    public sealed class AddSOSOMapCommand : BaseCommand
    {
        private IApplication application;
        private IHookHelper m_hookHelper;

        public AddSOSOMapCommand()
        {
            base.m_category = "VgsTiledMap";
            base.m_caption = "街道图(&M)";
            base.m_message = "添加腾讯街道图";
            base.m_toolTip = base.m_caption;
            base.m_name = "AddSOSOMapCommand";
        }
        ...
        public override void OnClick()
        {
            try
            {
                ...
                VgsArcTileLayer layer2 = new VgsArcTileLayer(this.application, EnumArcVgsTileLayer.SOSOMaps);
                layer2.Name = "SOSO街道图";
                layer2.Visible = true;
