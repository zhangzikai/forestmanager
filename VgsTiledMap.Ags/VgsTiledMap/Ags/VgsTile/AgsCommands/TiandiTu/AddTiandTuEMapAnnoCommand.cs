namespace VgsTiledMap.Ags.VgsTile.AgsCommands.TiandiTu
{
    ...
    [ClassInterface(ClassInterfaceType.None), Guid("70AA1A1B-4390-452d-9CF2-4855D37679B1"), ProgId("AddTiandTuEMapAnnoCommand")]
    public sealed class AddTiandTuEMapAnnoCommand : BaseCommand
    {
        private IApplication application;
        private IHookHelper m_hookHelper;

        public AddTiandTuEMapAnnoCommand()
        {
            base.m_category = "VgsTiledMap";
            base.m_caption = "天地图注记";
            base.m_message = "添加天地图注记图层";
            base.m_toolTip = base.m_caption;
            base.m_name = "AddTiandTuEMapAnnoCommand";
        }
