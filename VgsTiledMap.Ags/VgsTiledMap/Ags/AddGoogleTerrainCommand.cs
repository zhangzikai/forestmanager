namespace VgsTiledMap.Ags
{
    ...
    [Guid("B1818BCD-3D74-4d62-AC85-4A5D8DC8EAE4"), ProgId("AddGoogleTerrainCommand"), ClassInterface(ClassInterfaceType.None)]
    public sealed class AddGoogleTerrainCommand : BaseCommand
    {
        private IApplication application;
        private IHookHelper m_hookHelper;

        public AddGoogleTerrainCommand()
        {
            base.m_category = "VgsTiledMap";
            base.m_caption = "Google中国地形图(&T)";
            base.m_message = "添加Google中国地形图";
            base.m_toolTip = base.m_caption;
            base.m_name = "AddGoogleTerrainCommand";
        }
        ...
        public override void OnClick()
        {
            try
            {
                ...
                VgsArcTileLayer layer2 = new VgsArcTileLayer(this.application, EnumArcVgsTileLayer.GoogleTerrain);
                layer2.Name = "Google中国地形图";
                layer2.Visible = true;
