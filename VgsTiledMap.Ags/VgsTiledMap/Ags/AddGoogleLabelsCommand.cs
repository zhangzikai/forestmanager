namespace VgsTiledMap.Ags
{
    ...
    [Guid("A35CEA3B-8E08-4db0-9D24-EB2D4B66631D"), ProgId("AddGoogleLabelsCommand"), ClassInterface(ClassInterfaceType.None)]
    public sealed class AddGoogleLabelsCommand : BaseCommand
    {
        private IApplication application;
        private IHookHelper m_hookHelper;

        public AddGoogleLabelsCommand()
        {
            base.m_category = "VgsTiledMap";
            base.m_caption = "Google中国标注图(&L)";
            base.m_message = "添加google中国标注图";
            base.m_toolTip = base.m_caption;
            base.m_name = "AddGoogleLabelsCommand";
        }
        ...
        public override void OnClick()
        {
            try
            {
                ...
                VgsArcTileLayer layer2 = new VgsArcTileLayer(this.application, EnumArcVgsTileLayer.GoogleLabels);
                layer2.Name = "google中国标签图";
                layer2.Visible = true;
