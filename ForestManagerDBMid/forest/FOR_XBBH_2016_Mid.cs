...
{
[TDDBRecord(Table = "FOR_XBBH_2016")]
public class FOR_XBBH_2016_Mid
{
...
//字段别名:遥感判读图斑编号
[TDDBProperty(Column = "NO_TB", Index = 122)]
public string NO_TB { get; set; }
//字段别名:前期事权等级
[TDDBProperty(Column = "Q_SQ_D", Index = 123)]
public string Q_SQ_D { get; set; }
//字段别名:前期工程类别
[TDDBProperty(Column = "Q_GC_LB", Index = 124)]
public string Q_GC_LB { get; set; }
//字段别名:生态区位
[TDDBProperty(Column = "STQW", Index = 125)]
public string STQW { get; set; }
//字段别名:数据来源
[TDDBProperty(Column = "DT_SRC", Index = 126)]
public string DT_SRC { get; set; }
//字段别名:用地种类
[TDDBProperty(Column = "YDZL", Index = 127)]
