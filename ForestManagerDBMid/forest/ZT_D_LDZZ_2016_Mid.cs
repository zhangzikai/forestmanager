...
{
[TDDBRecord(Table = "ZT_D_LDZZ_2016")]
public class ZT_D_LDZZ_2016_Mid
{
...
//字段别名:优势树种
[TDDBProperty(Column = "YOU_SHI_SZ", Index = 35)]
public string YOU_SHI_SZ { get; set; }
//字段别名:起源
[TDDBProperty(Column = "QI_YUAN", Index = 36)]
public string QI_YUAN { get; set; }
//字段别名:平均年龄
[TDDBProperty(Column = "PINGJUN_NL", Index = 37)]
public int PINGJUN_NL { get; set; }
//字段别名:平均胸径
[TDDBProperty(Column = "PINGJUN_XJ", Index = 38)]
public double PINGJUN_XJ { get; set; }
//字段别名:平均树高
[TDDBProperty(Column = "PINGJUN_SG", Index = 39)]
public double PINGJUN_SG { get; set; }
//字段别名:平均断面
[TDDBProperty(Column = "PINGJUN_DM", Index = 40)]
public double PINGJUN_DM { get; set; }
//字段别名:龄组
[TDDBProperty(Column = "LING_ZU", Index = 41)]
public string LING_ZU { get; set; }
//字段别名:森林蓄积
[TDDBProperty(Column = "SLXJ", Index = 42)]
public int SLXJ { get; set; }
//字段别名:小班ID
[TDDBProperty(Column = "XBID", Index = 43)]
public string XBID { get; set; }
//字段别名:塔基名称
[TDDBProperty(Column = "TJMC", Index = 44)]
public string TJMC { get; set; }
//字段别名:塔基点X坐标
[TDDBProperty(Column = "TJ_X", Index = 45)]
public double TJ_X { get; set; }
//字段别名:塔基Y坐标
[TDDBProperty(Column = "TJ_Y", Index = 46)]
public double TJ_Y { get; set; }
//字段别名:是否退耕地
[TDDBProperty(Column = "SFTGD", Index = 47)]
public string SFTGD { get; set; }
//字段别名:备注
[TDDBProperty(Column = "BZ", Index = 48)]
public string BZ { get; set; }
//字段别名:林地补偿费单价
[TDDBProperty(Column = "LDBCDJ", Index = 49)]
public double LDBCDJ { get; set; }
//字段别名:林地补偿费
[TDDBProperty(Column = "LDBCF", Index = 50)]
public double LDBCF { get; set; }
//字段别名:林地安置费单价
[TDDBProperty(Column = "LDAZFDJ", Index = 51)]
public double LDAZFDJ { get; set; }
//字段别名:林地安置费
[TDDBProperty(Column = "LDAZF", Index = 52)]
public double LDAZF { get; set; }
//字段别名:林木补偿费单价
[TDDBProperty(Column = "LMBCDJ", Index = 53)]
public double LMBCDJ { get; set; }
//字段别名:林木补偿费
[TDDBProperty(Column = "LMBCF", Index = 54)]
public double LMBCF { get; set; }
//字段别名:补偿费合计
[TDDBProperty(Column = "BCFHJ", Index = 55)]
public double BCFHJ { get; set; }
//字段别名:植被恢复费单价
[TDDBProperty(Column = "ZBHFDJ", Index = 56)]
public double ZBHFDJ { get; set; }
//字段别名:植被恢复费
[TDDBProperty(Column = "ZBHFF", Index = 57)]
public double ZBHFF { get; set; }
//字段别名:总费用合计
[TDDBProperty(Column = "ZFYHJ", Index = 58)]
public double ZFYHJ { get; set; }
//字段别名:审核时间
[TDDBProperty(Column = "SHSJ", Index = 59)]
public string SHSJ { get; set; }
//字段别名:前期森林类别
[TDDBProperty(Column = "Q_SEN_LB", Index = 60)]
public string Q_SEN_LB { get; set; }
//字段别名:前期林种
[TDDBProperty(Column = "Q_LIN_ZHONG", Index = 61)]
public string Q_LIN_ZHONG { get; set; }
//字段别名:主体功能区
[TDDBProperty(Column = "QYKZ", Index = 62)]
public string QYKZ { get; set; }
//字段别名:林地功能分区
[TDDBProperty(Column = "LYFQ", Index = 63)]
public string LYFQ { get; set; }
//字段别名:林地质量等级
[TDDBProperty(Column = "ZL_DJ", Index = 64)]
public string ZL_DJ { get; set; }
//字段别名:审批面积
[TDDBProperty(Column = "SPMJ", Index = 65)]
public double SPMJ { get; set; }
//字段别名:伴生树种
[TDDBProperty(Column = "BSSZ", Index = 66)]
public string BSSZ { get; set; }
//字段别名:审批级别
[TDDBProperty(Column = "SPJB", Index = 67)]
public string SPJB { get; set; }
//字段别名:直接服务对象
[TDDBProperty(Column = "ZJFWDX", Index = 68)]
public string ZJFWDX { get; set; }
//字段别名:批准文号
[TDDBProperty(Column = "PZWH", Index = 69)]
public string PZWH { get; set; }
//字段别名:记录时间
[TDDBProperty(Column = "JLSJ", Index = 70)]
