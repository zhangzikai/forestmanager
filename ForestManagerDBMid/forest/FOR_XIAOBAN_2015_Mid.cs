...
{
[TDDBRecord(Table = "FOR_XIAOBAN_2015")]
public class FOR_XIAOBAN_2015_Mid
{
...
//字段别名:可及度
[TDDBProperty(Column = "KJD", Index = 145)]
public string KJD { get; set; }
//字段别名:高保护价值森林
[TDDBProperty(Column = "GBHJZSL", Index = 146)]
public string GBHJZSL { get; set; }
//字段别名:经营管理类型
[TDDBProperty(Column = "JYGLLX", Index = 147)]
public string JYGLLX { get; set; }
//字段别名:林地管理类型
[TDDBProperty(Column = "GLLX", Index = 148)]
public string GLLX { get; set; }
}
}
