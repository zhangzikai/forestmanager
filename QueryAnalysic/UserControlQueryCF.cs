namespace QueryAnalysic
{
    ...
    public class UserControlQueryCF : UserControlBase1
    {
        ...
        private ComboBoxEdit comboBoxL6;
        ...
        private DateEdit dateEditC4;
        private DateEdit dateEditC44;
        ...
        private const string mClassName = "QueryAnalysic.UserControlQueryCF";
        ...
        private void DoFind()
        {
            try
            {
                ...
                this.labelinfo.Text = "";
                string[] arr = UtilFactory.GetConfigOpt().GetConfigValue("CaiFaFieldNameD").Split(new char[] { ',' });
                ...
                string str2 = "";
                string configValue = UtilFactory.GetConfigOpt().GetConfigValue("CaiFaFieldTime");
                if (configValue == "")
                {
                    configValue = "GXSJ";
                }
                ...
                {
                    str2 = configValue + ">='" + DateTime.Parse(this.dateEdit1.Text).ToString("yyyyMMdd") + "'";
                }
                if (this.dateEdit2.Text != "")
                {
                    if (str2 == "")
                    {
                        str2 = configValue + "<='" + DateTime.Parse(this.dateEdit2.Text).ToString("yyyyMMdd") + "'";
                    }
                    else
                    {
                        str2 = str2 + " and " + configValue + "<='" + DateTime.Parse(this.dateEdit2.Text).ToString("yyyyMMdd") + "'";
                    }
                }
                if (str2 != "")
                {
                ...
                if (this.panelMore.Visible)
                {
                    ...
                    list.Add("date," + this.dateEditC4.Text + "," + this.dateEditC44.Text);
                    arr = UtilFactory.GetConfigOpt().GetConfigValue("CaiFaFieldNameC").Split(new char[] { ',' });
                    ...
                    list.Add("int," + this.spinEditB6.Text + "," + this.spinEditB66.Text);
                    list.Add("str," + this.textEditB7.Text);
                    arr = UtilFactory.GetConfigOpt().GetConfigValue("CaiFaFieldNameB").Split(new char[] { ',' });
                    ...
                    list.Add(this.comboBoxL6);
                    list.Add("int," + this.spinEditL2.Text + "," + this.spinEditL22.Text);
                    ...
                    list.Add("int," + this.spinEditL7.Text + "," + this.spinEditL77.Text);
                    list.Add("int," + this.spinEditL8.Text + "," + this.spinEditL88.Text);
                    arr = UtilFactory.GetConfigOpt().GetConfigValue("CaiFaFieldNameL").Split(new char[] { ',' });
                    whereString = this.GetWhereString(list, arr);
                    if (whereString != "")
                    {
                        if (str != "")
                ...
                {
                    this.labelinfo.Text = "      找到 " + num3 + " 个小班";
                    this.labelinfo.Visible = true;
                }
                return;
            Label_0C26:
                this.labelinfo.Text = "      请缩小查询范围，找到 大于" + num3 + " 个小班";
                this.labelinfo.Visible = true;
            }
            catch (Exception exception)
            {
                this.mErrOpt.ErrorOperate(this.mSubSysName, "QueryAnalysic.UserControlQueryCF", "DoFind", exception.GetHashCode().ToString(), exception.Source, exception.Message, "", "", "");
            }
        }
        ...
        private void InitialCombox(string[] arr, ArrayList list)
        {
            ...
            {
                this.mErrOpt.ErrorOperate(this.mSubSysName, "QueryAnalysic.UserControlQueryCF", "InitialCombox", exception.GetHashCode().ToString(), exception.Source, exception.Message, "", "", "");
            }
        }
        ...
        private void InitialDicCom()
        {
            try
            {
                ...
                list.Add(this.comboBoxC2);
                list.Add(this.comboBoxC3);
                this.dateEditC4.Text = "";
                this.dateEditC44.Text = "";
                string[] arr = UtilFactory.GetConfigOpt().GetConfigValue("CaiFaFieldNameC").Split(new char[] { ',' });
                ...
                list.Add(this.comboBoxB4);
                list.Add(this.comboBoxB5);
                this.spinEditB6.Value = 0M;
                this.spinEditB66.Value = 0M;
                this.textEditB7.Text = "";
                arr = UtilFactory.GetConfigOpt().GetConfigValue("CaiFaFieldNameB").Split(new char[] { ',' });
                this.InitialCombox(arr, list);
                list = new ArrayList();
                list.Add(this.comboBoxL1);
                list.Add(this.comboBoxL6);
                this.spinEditL2.Value = 0M;
                this.spinEditL22.Value = 0M;
        ...
        private void InitialDist()
        {
            try
            {
                ...
                string str = this.SQLSpectialCharacter(EditTask.EditWorkspace as IWorkspace, esriSQLSpecialCharacters.esriSQL_WildcardManyMatch);
                for (int i = 0; i < strArray.Length; i++)
                {
                    ComboBoxEdit edit = list[i] as ComboBoxEdit;
                    edit.Properties.Items.Clear();
                    ...
                    string str4 = UtilFactory.GetConfigOpt().GetConfigValue(strArray[i] + "CodeTableFieldCode");
                    ...
                    {
                        queryFilter.WhereClause = queryFilter.WhereClause + " and " + str4 + " like '" + EditTask.DistCode.Substring(0, 6) + str + "'";
                    }
                    ...
                    while (row != null)
                    {
                        ...
                        int num3 = row.Fields.FindField(str4);
            ...
            {
                this.mErrOpt.ErrorOperate(this.mSubSysName, "QueryAnalysic.UserControlQueryCF", "InitializeGISControls", exception.GetHashCode().ToString(), exception.Source, exception.Message, "", "", "");
            }
        }
        ...
        private void InitializeComponent()
        {
            ...
            this.dateEditC44 = new DevExpress.XtraEditors.DateEdit();
            this.label6 = new System.Windows.Forms.Label();
            this.dateEditC4 = new DevExpress.XtraEditors.DateEdit();
            ...
            this.textEditB7 = new DevExpress.XtraEditors.TextEdit();
            ...
            this.comboBoxL6 = new DevExpress.XtraEditors.ComboBoxEdit();
            ...
            ((System.ComponentModel.ISupportInitialize)(this.dateEditC44.Properties.CalendarTimeProperties)).BeginInit();
            ((System.ComponentModel.ISupportInitialize)(this.dateEditC44.Properties)).BeginInit();
            ((System.ComponentModel.ISupportInitialize)(this.dateEditC4.Properties.CalendarTimeProperties)).BeginInit();
            ((System.ComponentModel.ISupportInitialize)(this.dateEditC4.Properties)).BeginInit();
            ...
            ((System.ComponentModel.ISupportInitialize)(this.textEditB7.Properties)).BeginInit();
            ...
            ((System.ComponentModel.ISupportInitialize)(this.comboBoxL6.Properties)).BeginInit();
            ...
            this.spinEditL33.Size = new System.Drawing.Size(58, 20);
            ...
            this.simpleButtonReset.Location = new System.Drawing.Point(52, 4);
            ...
            this.panel33.Location = new System.Drawing.Point(112, 4);
            ...
            this.simpleButtonMore.Location = new System.Drawing.Point(118, 4);
            ...
            this.panel32.Location = new System.Drawing.Point(178, 4);
            ...
            this.ButtonFind.Location = new System.Drawing.Point(184, 4);
            ...
            this.panelMore.Location = new System.Drawing.Point(9, 220);
            this.panelMore.Name = "panelMore";
            this.panelMore.Padding = new System.Windows.Forms.Padding(0, 2, 0, 0);
            this.panelMore.Size = new System.Drawing.Size(244, 233);
            ...
            this.xtraTabControl1.Size = new System.Drawing.Size(244, 231);
            ...
            // xtraTabPage3
            // 
            this.xtraTabPage3.Controls.Add(this.panel29);
            this.xtraTabPage3.Controls.Add(this.panel17);
            this.xtraTabPage3.Controls.Add(this.panel15);
            this.xtraTabPage3.Controls.Add(this.panel13);
            this.xtraTabPage3.Name = "xtraTabPage3";
            this.xtraTabPage3.Size = new System.Drawing.Size(238, 202);
            this.xtraTabPage3.Text = "更新调查";
            // 
            // panel29
            // 
            this.panel29.Controls.Add(this.dateEditC44);
            this.panel29.Controls.Add(this.label6);
            this.panel29.Controls.Add(this.dateEditC4);
            ...
            this.panel29.Size = new System.Drawing.Size(238, 26);
            this.panel29.TabIndex = 22;
            // 
            // dateEditC44
            // 
            this.dateEditC44.Dock = System.Windows.Forms.DockStyle.Fill;
            this.dateEditC44.EditValue = null;
            this.dateEditC44.Location = new System.Drawing.Point(160, 4);
            this.dateEditC44.Name = "dateEditC44";
            this.dateEditC44.Properties.Buttons.AddRange(new DevExpress.XtraEditors.Controls.EditorButton[] {
            new DevExpress.XtraEditors.Controls.EditorButton(DevExpress.XtraEditors.Controls.ButtonPredefines.Combo)});
            this.dateEditC44.Properties.CalendarTimeProperties.Buttons.AddRange(new DevExpress.XtraEditors.Controls.EditorButton[] {
            new DevExpress.XtraEditors.Controls.EditorButton()});
            this.dateEditC44.Size = new System.Drawing.Size(72, 20);
            this.dateEditC44.TabIndex = 27;
            // 
            // label6
            // 
            ...
            this.label6.Size = new System.Drawing.Size(12, 22);
            ...
            // dateEditC4
            // 
            this.dateEditC4.Dock = System.Windows.Forms.DockStyle.Left;
            this.dateEditC4.EditValue = null;
            this.dateEditC4.Location = new System.Drawing.Point(74, 4);
            this.dateEditC4.Name = "dateEditC4";
            this.dateEditC4.Properties.Buttons.AddRange(new DevExpress.XtraEditors.Controls.EditorButton[] {
            new DevExpress.XtraEditors.Controls.EditorButton(DevExpress.XtraEditors.Controls.ButtonPredefines.Combo)});
            this.dateEditC4.Properties.CalendarTimeProperties.Buttons.AddRange(new DevExpress.XtraEditors.Controls.EditorButton[] {
            new DevExpress.XtraEditors.Controls.EditorButton()});
            this.dateEditC4.Size = new System.Drawing.Size(74, 20);
            this.dateEditC4.TabIndex = 25;
            // 
            // label29
            // 
            ...
            this.comboBoxC3.Location = new System.Drawing.Point(74, 4);
            ...
            "不可编辑",
            "已提交"});
            this.comboBoxC3.Size = new System.Drawing.Size(158, 20);
            ...
            this.comboBoxC2.Location = new System.Drawing.Point(74, 4);
            ...
            "不可编辑",
            "已提交"});
            this.comboBoxC2.Size = new System.Drawing.Size(158, 20);
            ...
            this.comboBoxC1.Location = new System.Drawing.Point(74, 4);
            ...
            "不可编辑",
            "已提交"});
            this.comboBoxC1.Size = new System.Drawing.Size(158, 20);
            ...
            this.xtraTabPage1.Size = new System.Drawing.Size(238, 202);
            this.xtraTabPage1.Text = "基本信息";
            // 
            // panel4
            // 
            this.panel4.Controls.Add(this.textEditB7);
            ...
            // textEditB7
            // 
            this.textEditB7.Dock = System.Windows.Forms.DockStyle.Fill;
            this.textEditB7.Location = new System.Drawing.Point(74, 4);
            this.textEditB7.Name = "textEditB7";
            this.textEditB7.Size = new System.Drawing.Size(158, 20);
            this.textEditB7.TabIndex = 23;
            // 
            // label20
            // 
            ...
            this.panel22.Size = new System.Drawing.Size(238, 25);
            ...
            0,
            0});
            this.spinEditB66.Location = new System.Drawing.Point(174, 4);
            ...
            this.spinEditB66.Size = new System.Drawing.Size(58, 20);
            ...
            this.panel23.Size = new System.Drawing.Size(238, 25);
            ...
            "不可编辑",
            "已提交"});
            this.comboBoxB5.Size = new System.Drawing.Size(158, 20);
            ...
            this.panel24.Size = new System.Drawing.Size(238, 25);
            ...
            "不可编辑",
            "已提交"});
            this.comboBoxB4.Size = new System.Drawing.Size(158, 20);
            ...
            this.panel19.Size = new System.Drawing.Size(238, 25);
            ...
            "不可编辑",
            "已提交"});
            this.comboBoxB3.Size = new System.Drawing.Size(158, 20);
            ...
            this.panel25.Size = new System.Drawing.Size(238, 25);
            ...
            "不可编辑",
            "已提交"});
            this.comboBoxB2.Size = new System.Drawing.Size(158, 20);
            ...
            this.panel18.Size = new System.Drawing.Size(238, 25);
            ...
            "不可编辑",
            "已提交"});
            this.comboBoxB1.Size = new System.Drawing.Size(158, 20);
            ...
            // xtraTabPage2
            // 
            this.xtraTabPage2.Controls.Add(this.panel38);
            this.xtraTabPage2.Controls.Add(this.panel37);
            ...
            this.xtraTabPage2.Size = new System.Drawing.Size(238, 202);
            this.xtraTabPage2.Text = "采伐作业";
            // 
            // panel38
            // 
            this.panel38.Controls.Add(this.spinEditL88);
            this.panel38.Controls.Add(this.label36);
            this.panel38.Controls.Add(this.spinEditL8);
            this.panel38.Controls.Add(this.label37);
            this.panel38.Dock = System.Windows.Forms.DockStyle.Top;
            this.panel38.Location = new System.Drawing.Point(0, 175);
            this.panel38.Name = "panel38";
            this.panel38.Padding = new System.Windows.Forms.Padding(2, 4, 6, 0);
            this.panel38.Size = new System.Drawing.Size(238, 25);
            ...
            this.spinEditL88.Size = new System.Drawing.Size(58, 20);
            this.spinEditL88.TabIndex = 11;
            // 
            // label36
            // 
            ...
            this.label37.Text = "采伐出材量:";
            this.label37.TextAlign = System.Drawing.ContentAlignment.MiddleCenter;
            // 
            // panel37
            // 
            this.panel37.Controls.Add(this.spinEditL77);
            this.panel37.Controls.Add(this.label34);
            this.panel37.Controls.Add(this.spinEditL7);
            this.panel37.Controls.Add(this.label35);
            this.panel37.Dock = System.Windows.Forms.DockStyle.Top;
            this.panel37.Location = new System.Drawing.Point(0, 150);
            this.panel37.Name = "panel37";
            this.panel37.Padding = new System.Windows.Forms.Padding(2, 4, 6, 0);
            this.panel37.Size = new System.Drawing.Size(238, 25);
            ...
            this.spinEditL77.Size = new System.Drawing.Size(58, 20);
            ...
            this.label35.Text = "采伐年龄:";
            this.label35.TextAlign = System.Drawing.ContentAlignment.MiddleCenter;
            // 
            // panel28
            // 
            this.panel28.Controls.Add(this.spinEditL55);
            this.panel28.Controls.Add(this.label38);
            this.panel28.Controls.Add(this.spinEditL5);
            ...
            this.panel28.Size = new System.Drawing.Size(238, 25);
            ...
            this.spinEditL55.Size = new System.Drawing.Size(58, 20);
            this.spinEditL55.TabIndex = 14;
            // 
            // label38
            // 
            ...
            this.label28.Text = "采伐株数:";
            this.label28.TextAlign = System.Drawing.ContentAlignment.MiddleCenter;
            // 
            // panel27
            // 
            this.panel27.Controls.Add(this.spinEditL44);
            this.panel27.Controls.Add(this.label25);
            this.panel27.Controls.Add(this.spinEditL4);
            ...
            this.panel27.Size = new System.Drawing.Size(238, 25);
            ...
            0,
            0});
            this.spinEditL44.Location = new System.Drawing.Point(174, 4);
            ...
            new DevExpress.XtraEditors.Controls.EditorButton()});
            this.spinEditL44.Properties.Increment = new decimal(new int[] {
            1,
            0,
            0,
            65536});
            this.spinEditL44.Properties.Mask.EditMask = "d";
            this.spinEditL44.Size = new System.Drawing.Size(58, 20);
            ...
            0,
            0});
            this.spinEditL4.Location = new System.Drawing.Point(74, 4);
            ...
            this.panel21.Size = new System.Drawing.Size(238, 25);
            ...
            this.spinEditL22.Size = new System.Drawing.Size(58, 20);
            ...
            this.label17.Text = "采伐面积:";
            this.label17.TextAlign = System.Drawing.ContentAlignment.MiddleCenter;
            // 
            // panel26
            // 
            this.panel26.Controls.Add(this.comboBoxL6);
            ...
            this.panel26.Size = new System.Drawing.Size(238, 25);
            this.panel26.TabIndex = 26;
            // 
            // comboBoxL6
            // 
            this.comboBoxL6.Dock = System.Windows.Forms.DockStyle.Fill;
            this.comboBoxL6.EditValue = "--";
            this.comboBoxL6.Location = new System.Drawing.Point(74, 4);
            this.comboBoxL6.Name = "comboBoxL6";
            this.comboBoxL6.Properties.Buttons.AddRange(new DevExpress.XtraEditors.Controls.EditorButton[] {
            new DevExpress.XtraEditors.Controls.EditorButton(DevExpress.XtraEditors.Controls.ButtonPredefines.Combo)});
            this.comboBoxL6.Properties.Items.AddRange(new object[] {
            "--",
            "可编辑",
            "不可编辑",
            "已提交"});
            this.comboBoxL6.Size = new System.Drawing.Size(158, 20);
            this.comboBoxL6.TabIndex = 22;
            // 
            // label26
            // 
            ...
            this.panel20.Size = new System.Drawing.Size(238, 25);
            ...
            "不可编辑",
            "已提交"});
            this.comboBoxL1.Size = new System.Drawing.Size(158, 20);
            ...
            this.panelbasic.Size = new System.Drawing.Size(244, 198);
            ...
            this.panelDistLocation.Size = new System.Drawing.Size(182, 197);
            ...
            this.panel10.Size = new System.Drawing.Size(182, 197);
            ...
            this.panel35.Size = new System.Drawing.Size(182, 23);
            ...
            this.panel31.Size = new System.Drawing.Size(182, 6);
            ...
            new DevExpress.XtraEditors.Controls.EditorButton(DevExpress.XtraEditors.Controls.ButtonPredefines.Combo)});
            this.comboBoxXiban.Size = new System.Drawing.Size(182, 20);
            ...
            this.panel30.Size = new System.Drawing.Size(182, 6);
            ...
            new DevExpress.XtraEditors.Controls.EditorButton(DevExpress.XtraEditors.Controls.ButtonPredefines.Combo)});
            this.comboBoxXiaoban.Size = new System.Drawing.Size(182, 20);
            ...
            this.panel6.Size = new System.Drawing.Size(182, 6);
            ...
            new DevExpress.XtraEditors.Controls.EditorButton(DevExpress.XtraEditors.Controls.ButtonPredefines.Combo)});
            this.comboBoxLinban.Size = new System.Drawing.Size(182, 20);
            ...
            this.panel1.Size = new System.Drawing.Size(182, 6);
            ...
            this.comboBoxVillage.Size = new System.Drawing.Size(182, 20);
            ...
            this.panel12.Size = new System.Drawing.Size(182, 6);
            ...
            this.comboBoxTown.Size = new System.Drawing.Size(182, 20);
            ...
            this.panel11.Size = new System.Drawing.Size(182, 6);
            ...
            this.comboBoxCounty.Size = new System.Drawing.Size(182, 20);
            ...
            this.panel14.Size = new System.Drawing.Size(182, 6);
            ...
            this.panel9.Size = new System.Drawing.Size(62, 197);
            ...
            this.panel7.Location = new System.Drawing.Point(114, 6);
            ...
            this.treeList.Size = new System.Drawing.Size(246, 19);
            ...
            this.labelinfo.Location = new System.Drawing.Point(8, 67);
            this.labelinfo.Name = "labelinfo";
            this.labelinfo.Size = new System.Drawing.Size(246, 26);
            ...
            this.labelLocation.Text = "      采伐小班查找";
            ...
            ((System.ComponentModel.ISupportInitialize)(this.dateEditC44.Properties.CalendarTimeProperties)).EndInit();
            ((System.ComponentModel.ISupportInitialize)(this.dateEditC44.Properties)).EndInit();
            ((System.ComponentModel.ISupportInitialize)(this.dateEditC4.Properties.CalendarTimeProperties)).EndInit();
            ((System.ComponentModel.ISupportInitialize)(this.dateEditC4.Properties)).EndInit();
            ...
            ((System.ComponentModel.ISupportInitialize)(this.textEditB7.Properties)).EndInit();
            ...
            ((System.ComponentModel.ISupportInitialize)(this.comboBoxL6.Properties)).EndInit();
        ...
        public void InitialValue(object hook, IFeatureLayer pFeatureLayer, IMap pMap, QueryCommon.UserControlQueryResult pResult, DockPanel pDockPanel)
        {
            ...
            {
                this.mErrOpt.ErrorOperate(this.mSubSysName, "QueryAnalysic.UserControlQueryCF", "InitialValue", exception.GetHashCode().ToString(), exception.Source, exception.Message, "", "", "");
            }
        }
        ...
        private void SetDist(string code, DataTable ptable, ComboBoxEdit combox)
        {
            ...
            {
                this.mErrOpt.ErrorOperate(this.mSubSysName, "QueryAnalysic.UserControlQueryCF", "SetDist", exception.GetHashCode().ToString(), exception.Source, exception.Message, "", "", "");
            }
        }
        ...
        private string SQLSpectialCharacter(IWorkspace pWorkspace, esriSQLSpecialCharacters enmSqlSpecialCharacters)
        {
            try
            {
                ISQLSyntax syntax = pWorkspace as ISQLSyntax;
                return syntax.GetSpecialCharacter(enmSqlSpecialCharacters);
            }
            catch (Exception exception)
            {
                this.mErrOpt.ErrorOperate(this.mSubSysName, "QueryAnalysic.UserControlQueryCF", "SqlSpectialCharacter", exception.GetHashCode().ToString(), exception.Source, exception.Message, "", "", "");
                return "";
            }
        }
