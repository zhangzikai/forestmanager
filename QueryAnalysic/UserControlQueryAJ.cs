namespace QueryAnalysic
{
    ...
    public class UserControlQueryAJ : UserControlBase1
    {
        ...
        private const string mClassName = "QueryAnalysic.UserControlQueryAJ";
        private DockPanel mDockPanel;
        private string mEditKindCode = "AnJian";
        ...
        private void DoFind()
        {
            try
            {
                ...
                if (this.panelMore.Visible)
                {
                    ...
                    list.Add("double," + this.spinEditL3.Text + "," + this.spinEditL33.Text);
            ...
            {
                this.mErrOpt.ErrorOperate(this.mSubSysName, "QueryAnalysic.UserControlQueryAJ", "DoFind", exception.GetHashCode().ToString(), exception.Source, exception.Message, "", "", "");
            }
        }
        ...
        private void InitialCombox(string[] arr, ArrayList list)
        {
            ...
            {
                this.mErrOpt.ErrorOperate(this.mSubSysName, "QueryAnalysic.UserControlQueryAJ", "InitialCombox", exception.GetHashCode().ToString(), exception.Source, exception.Message, "", "", "");
            }
        }
        ...
        private void InitialDicCom()
        {
            ...
            {
                this.mErrOpt.ErrorOperate(this.mSubSysName, "QueryAnalysic.UserControlQueryAJ", "InitialDicCom", exception.GetHashCode().ToString(), exception.Source, exception.Message, "", "", "");
            }
        }
        ...
        private void InitialDist()
        {
            ...
            {
                this.mErrOpt.ErrorOperate(this.mSubSysName, "QueryAnalysic.UserControlQueryAJ", "InitializeGISControls", exception.GetHashCode().ToString(), exception.Source, exception.Message, "", "", "");
            }
        }
        ...
        private void InitializeComponent()
        {
            ...
            this.spinEditL5.EditValueChanged += new System.EventHandler(this.spinEditL6_EditValueChanged);
            // 
            // label28
            // 
            ...
            0,
            0});
            this.spinEditL33.Location = new System.Drawing.Point(164, 4);
            ...
            new DevExpress.XtraEditors.Controls.EditorButton()});
            this.spinEditL33.Properties.Increment = new decimal(new int[] {
            1,
            0,
            0,
            65536});
            this.spinEditL33.Properties.Mask.EditMask = "d";
            this.spinEditL33.Size = new System.Drawing.Size(68, 20);
            this.spinEditL33.TabIndex = 14;
            // 
            // label6
            // 
            ...
            this.labelLocation.Text = "      案件班块查询";
        ...
        private void SetDist(string code, DataTable ptable, ComboBoxEdit combox)
        {
            ...
            {
                this.mErrOpt.ErrorOperate(this.mSubSysName, "QueryAnalysic.UserControlQueryAJ", "SetDist", exception.GetHashCode().ToString(), exception.Source, exception.Message, "", "", "");
            }
        }
