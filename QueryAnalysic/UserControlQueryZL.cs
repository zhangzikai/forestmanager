namespace QueryAnalysic
{
    ...
    public class UserControlQueryZL : UserControlBase1
    {
        ...
        private const string mClassName = "QueryAnalysic.UserControlQueryZL";
        private DockPanel mDockPanel;
        private string mEditKindCode = "ZaoLin";
        ...
        private void DoFind()
        {
            try
            {
                ...
                if (this.panelMore.Visible)
                {
                    ...
                    list.Add("date," + this.spinEditL5.Text + "," + this.spinEditL55.Text);
                    list.Add("date," + this.spinEditL6.Text + "," + this.spinEditL66.Text);
                    list.Add("str," + this.textEditL7.Text);
                ...
                int num3 = this.mEditLayer.FeatureClass.FeatureCount(queryFilter);
                if (num3 == 0)
                {
                ...
                IFeatureCursor cursor = this.mEditLayer.FeatureClass.Search(queryFilter, false);
            ...
            {
                this.mErrOpt.ErrorOperate(this.mSubSysName, "QueryAnalysic.UserControlQueryZL", "DoFind", exception.GetHashCode().ToString(), exception.Source, exception.Message, "", "", "");
            }
        }
        ...
        private void InitialCombox(string[] arr, ArrayList list)
        {
            ...
            {
                this.mErrOpt.ErrorOperate(this.mSubSysName, "QueryAnalysic.UserControlQueryZL", "InitialCombox", exception.GetHashCode().ToString(), exception.Source, exception.Message, "", "", "");
            }
        }
        ...
        private void InitialDicCom()
        {
            try
            {
                ...
                this.textEditL7.Text = "";
                arr = UtilFactory.GetConfigOpt().GetConfigValue(this.mEditKindCode + "FieldNameL").Split(new char[] { ',' });
                this.InitialCombox(arr, list);
            }
            catch (Exception exception)
            {
                this.mErrOpt.ErrorOperate(this.mSubSysName, "QueryAnalysic.UserControlQueryZL", "InitialDicCom", exception.GetHashCode().ToString(), exception.Source, exception.Message, "", "", "");
            }
        }
        ...
        private void InitialDist()
        {
            ...
            {
                this.mErrOpt.ErrorOperate(this.mSubSysName, "QueryAnalysic.UserControlQueryZL", "InitializeGISControls", exception.GetHashCode().ToString(), exception.Source, exception.Message, "", "", "");
            }
        }
        ...
        private void InitializeComponent()
        {
            ...
            this.textEditL7 = new DevExpress.XtraEditors.TextEdit();
            ...
            ((System.ComponentModel.ISupportInitialize)(this.textEditL7.Properties)).BeginInit();
            ...
            this.xtraTabPage2.Text = "造林作业";
            // 
            // panel37
            // 
            this.panel37.Controls.Add(this.textEditL7);
            ...
            // textEditL7
            // 
            this.textEditL7.Dock = System.Windows.Forms.DockStyle.Fill;
            this.textEditL7.Location = new System.Drawing.Point(74, 4);
            this.textEditL7.Name = "textEditL7";
            this.textEditL7.Size = new System.Drawing.Size(158, 20);
            this.textEditL7.TabIndex = 24;
            // 
            // label35
            // 
            ...
            this.spinEditL66.Size = new System.Drawing.Size(58, 20);
            ...
            "不可编辑",
            "已提交"});
            this.comboBoxL4.Size = new System.Drawing.Size(158, 20);
            ...
            "不可编辑",
            "已提交"});
            this.comboBoxL3.Size = new System.Drawing.Size(158, 20);
            ...
            this.simpleButtonSelect.TabIndex = 105;
            ...
            this.labelLocation.Text = "      造林小班查找";
            ...
            ((System.ComponentModel.ISupportInitialize)(this.textEditL7.Properties)).EndInit();
        ...
        private void SetDist(string code, DataTable ptable, ComboBoxEdit combox)
        {
            ...
            {
                this.mErrOpt.ErrorOperate(this.mSubSysName, "QueryAnalysic.UserControlQueryZL", "SetDist", exception.GetHashCode().ToString(), exception.Source, exception.Message, "", "", "");
            }
        }
