namespace QueryAnalysic
{
    ...
    public class XBPointTool : BaseTool
    {
        private const string mClassName = "XBPointTool";
        private IHookHelper mHookHelper;
        private UserControlQueryHisXB mMyParent;
        ...
        public UserControl ParentForm
        {
            set
            {
                this.mMyParent = value as UserControlQueryHisXB;
            }
        }
    }
}
