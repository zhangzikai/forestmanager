...
namespace ConSQLServerInfo
{
    public class ConnectionSQLServerString
    {
        public static string Get_M_Str_ConnectionString()
        {
            ...
            //    }
            //}
            M_Str_ConnectionString = "Data Source=" + "114.215.140.122" + ";Initial Catalog=" + "sde" + ";User ID=" + "sde" + ";Password=" + "sde" + ";Persist Security Info=false;";
