namespace ProxyButton
{
    ...
    public class MapIdentifyTool : BaseTool
    {
        private IHookHelper m_hookHelper;
        private const string mClassName = "ProxyButton.MapIdentifyTool";
        ...
        public MapIdentifyTool()
        {
            ...
            base.m_message = "查看";
            base.m_toolTip = "查看";
            base.m_name = "MapIdentifyTool";
            try
            {
                base.m_bitmap = new Bitmap(this.GetType(), "IdentifyTool.bmp");
                base.m_cursor = new Cursor(this.GetType(), "Identify.cur");
            }
        ...
        public override void OnCreate(object hook)
        {
            ...
            if (hook != null)
            {
                ...
                this.pTool = new ControlsMapIdentifyToolClass();
        ...
        {
            base.m_cursor = new Cursor(this.GetType(), "ProxyButton.Identify_md.cur");
        ...
        {
            base.m_cursor = new Cursor(this.GetType(), "ProxyButton.Identify.cur");
