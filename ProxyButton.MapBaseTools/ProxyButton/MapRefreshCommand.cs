namespace ProxyButton
{
    ...
    public class MapRefreshCommand : BaseCommand
    {
        private IHookHelper m_hookHelper;
        private const string mClassName = "ProxyButton.MapRefreshCommand";
        private ErrorOpt mErrOpt = UtilFactory.GetErrorOpt();
        private string mSubSysName = UtilFactory.GetConfigOpt().GetSystemName();
        private ICommand pCom;
        private ITool pTool;

        public MapRefreshCommand()
        {
            base.m_category = "地图浏览";
            base.m_caption = "刷新";
            base.m_message = "地图刷新";
            base.m_toolTip = "地图刷新";
            base.m_name = "MapRefreshCommand";
            try
            {
                base.m_bitmap = new Bitmap(this.GetType(), "刷新6.bmp");
            }
        ...
        public override void OnCreate(object hook)
        {
            ...
            if (hook != null)
            {
                ...
                this.pCom = new ControlsMapRefreshViewCommandClass();
