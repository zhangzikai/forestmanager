namespace ProxyButton
{
    ...
    public class MapZoomInTool : BaseTool
    {
        private IHookHelper m_hookHelper;
        private const string mClassName = "ProxyButton.MapZoomInTool";
        ...
        public MapZoomInTool()
        {
            ...
            base.m_message = "地图放大";
            base.m_toolTip = "地图放大";
            base.m_name = "MapZoomInTool";
            try
            {
                base.m_bitmap = new Bitmap(this.GetType(), "ZoomIn.bmp");
                base.m_cursor = new Cursor(this.GetType(), "ZoomIn.cur");
            }
        ...
        public override void OnCreate(object hook)
        {
            ...
            if (hook != null)
            {
                ...
                this.pTool = new ControlsMapZoomInToolClass();
        ...
        {
            base.m_cursor = new Cursor(this.GetType(), "ProxyButton.ZoomIn.cur");
            this.pTool.OnMouseDown(Button, Shift, X, Y);
        }

        public override void OnMouseMove(int Button, int Shift, int X, int Y)
        {
            base.m_cursor = new Cursor(this.GetType(), "ProxyButton.ZoomInMove.cur");
