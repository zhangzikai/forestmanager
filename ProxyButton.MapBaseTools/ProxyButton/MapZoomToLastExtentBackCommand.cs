namespace ProxyButton
{
    ...
    public class MapZoomToLastExtentBackCommand : BaseCommand
    {
        private IHookHelper m_hookHelper;
        private const string mClassName = "ProxyButton.MapZoomToLastExtentBackCommand";
        ...
        public MapZoomToLastExtentBackCommand()
        {
            ...
            base.m_message = "后一视图";
            base.m_toolTip = "后一视图";
            base.m_name = "MapZoomToLastExtentBackCommand";
            try
            {
                base.m_bitmap = new Bitmap(this.GetType(), "last.png");
            }
        ...
        public override void OnCreate(object hook)
        {
            ...
            if (hook != null)
            {
                ...
                this.pCom = new ControlsMapZoomToLastExtentBackCommandClass();
