namespace ProxyButton
{
    ...
    public class MapFullExtentCommand : BaseCommand
    {
        private IHookHelper m_hookHelper;
        private const string mClassName = "ProxyButton.MapFullExtentCommand";
        ...
        public MapFullExtentCommand()
        {
            ...
            base.m_message = "全图";
            base.m_toolTip = "全图";
            base.m_name = "MapFullExtentCommand";
            try
            {
        ...
        public override void OnCreate(object hook)
        {
            ...
            if (hook != null)
            {
                ...
                this.pCom = new ControlsMapFullExtentCommandClass();
