namespace ProxyButton
{
    ...
    public class MapPageUpCommand : BaseCommand
    {
        private IHookHelper m_hookHelper;
        private const string mClassName = "ProxyButton.MapPageUpCommand";
        private ErrorOpt mErrOpt = UtilFactory.GetErrorOpt();
        private string mSubSysName = UtilFactory.GetConfigOpt().GetSystemName();
        private ICommand pCom;
        private ITool pTool;

        public MapPageUpCommand()
        {
            base.m_category = "地图浏览";
            base.m_caption = "向上";
            base.m_message = "向上";
            base.m_toolTip = "向上";
            base.m_name = "MapPageUpCommand";
            try
            {
                base.m_bitmap = new Bitmap(this.GetType(), "arrow_state_blue_collapsed.png");
            }
        ...
        public override void OnCreate(object hook)
        {
            ...
            if (hook != null)
            {
                ...
                this.pCom = new ControlsMapPageUpCommandClass();
