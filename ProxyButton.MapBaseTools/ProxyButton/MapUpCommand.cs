namespace ProxyButton
{
    ...
    public class MapUpCommand : BaseCommand
    {
        private IHookHelper m_hookHelper;
        private const string mClassName = "ProxyButton.MapDownCommand";
        ...
        public override void OnCreate(object hook)
        {
            ...
            if (hook != null)
            {
                ...
                this.pCom = new ControlsMapUpCommandClass();
