namespace ProxyButton
{
    ...
    public class MapPageLeftCommand : BaseCommand
    {
        private IHookHelper m_hookHelper;
        private const string mClassName = "ProxyButton.MapPageLeftCommand";
        private ErrorOpt mErrOpt = UtilFactory.GetErrorOpt();
        private string mSubSysName = UtilFactory.GetConfigOpt().GetSystemName();
        private ICommand pCom;
        private ITool pTool;

        public MapPageLeftCommand()
        {
            base.m_category = "地图浏览";
            base.m_caption = "向左";
            base.m_message = "向左";
            base.m_toolTip = "向左";
            base.m_name = "MapPageLeftCommand";
            try
            {
                base.m_bitmap = new Bitmap(this.GetType(), "arrow_state_blue_left.png");
            }
        ...
        public override void OnCreate(object hook)
        {
            ...
            if (hook != null)
            {
                ...
                this.pCom = new ControlsMapPageLeftCommandClass();
