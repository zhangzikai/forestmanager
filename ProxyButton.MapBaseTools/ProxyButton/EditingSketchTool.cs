namespace ProxyButton
{
    ...
    public class EditingSketchTool : BaseTool
    {
        private IHookHelper m_hookHelper;
        private const string mClassName = "ProxyButton.EditingSketchTool";
        private ErrorOpt mErrOpt = UtilFactory.GetErrorOpt();
        private string mSubSysName = UtilFactory.GetConfigOpt().GetSystemName();
        private ICommand pCom;
        private ITool pTool;

        public EditingSketchTool()
        {
            base.m_category = "地图编辑";
            base.m_caption = "新增";
            base.m_message = "新增要素";
            base.m_toolTip = "新增要素";
            base.m_name = "EditingSketchTool";
            try
            {
