namespace ProxyButton
{
    ...
    public class MapZoomOutFixedCommand : BaseCommand
    {
        private IHookHelper m_hookHelper;
        private const string mClassName = "ProxyButton.MapZoomOutFixedCommand";
        ...
        public MapZoomOutFixedCommand()
        {
            ...
            base.m_message = "固定缩小";
            base.m_toolTip = "固定缩小";
            base.m_name = "MapZoomOutFixedCommand";
            try
            {
                base.m_bitmap = new Bitmap(this.GetType(), "FixedZoomOut.bmp");
            }
        ...
        public override void OnCreate(object hook)
        {
            ...
            if (hook != null)
            {
                ...
                this.pCom = new ControlsMapZoomOutFixedCommandClass();
