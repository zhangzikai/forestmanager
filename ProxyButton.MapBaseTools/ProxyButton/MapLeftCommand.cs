namespace ProxyButton
{
    ...
    public class MapLeftCommand : BaseCommand
    {
        private IHookHelper m_hookHelper;
        private const string mClassName = "ProxyButton.MapLeftCommand";
        private ErrorOpt mErrOpt = UtilFactory.GetErrorOpt();
        private string mSubSysName = UtilFactory.GetConfigOpt().GetSystemName();
        private ICommand pCom;
        private ITool pTool;

        public MapLeftCommand()
        {
            base.m_category = "地图浏览";
            base.m_caption = "向左";
            base.m_message = "向左";
            base.m_toolTip = "向左";
            base.m_name = "MapLeftCommand";
            try
            {
        ...
        public override void OnCreate(object hook)
        {
            ...
            if (hook != null)
            {
                ...
                this.pCom = new ControlsMapRightCommandClass();
