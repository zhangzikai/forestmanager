namespace ProxyButton
{
    ...
    public class FeatureSelectionClearSelectionCommand : BaseCommand
    {
        private IHookHelper m_hookHelper;
        private const string mClassName = "ProxyButton.FeatureSelectionClearSelectionCommand";
        private ErrorOpt mErrOpt = UtilFactory.GetErrorOpt();
        private string mSubSysName = UtilFactory.GetConfigOpt().GetSystemName();
        private ICommand pCom;
        private ITool pTool;

        public FeatureSelectionClearSelectionCommand()
        {
            base.m_category = "要素选择";
            base.m_caption = "图形选择";
            base.m_message = "通过被选中图形选择相关的要素";
            base.m_toolTip = "通过图形选择";
            base.m_name = "ClearSelectionCommand";
            try
            {
                base.m_bitmap = new Bitmap(this.GetType(), "ClearSelection.bmp");
            }
        ...
        public override void OnCreate(object hook)
        {
            ...
            if (hook != null)
            {
                ...
                this.pCom = new ControlsClearSelectionCommandClass();
