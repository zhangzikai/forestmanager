namespace Measure
{
    ...
    public class MeasureAreaTool2 : BaseTool
    {
        ...
        public MeasureAreaTool2(FormMeasure form)
        {
            base.m_category = "量算";
            base.m_caption = "面积量算";
            base.m_message = "面积量算工具";
            base.m_toolTip = "面积量算工具";
            base.m_name = "MeasureAreaTool2";
            this.mFormMeasure = form;
            try
            {
                base.m_bitmap = new Bitmap(this.GetType(), "Measure.MeasureArea.bmp");
                base.m_cursor = new Cursor(this.GetType(), "Measure.MeasureArea.cur");
            }
            ...
            try
            {
                if (this.mInUsing && (this.mFeedback != null))
                {
                    ...
                    if ((polygon != null) && !polygon.IsEmpty)
                    {
                        ...
                        this.mFormMeasure.SetMeasureResult(activeView, pElement, polygon, pFillSymbol);
