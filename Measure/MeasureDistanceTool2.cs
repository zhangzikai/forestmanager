namespace Measure
{
    ...
    public class MeasureDistanceTool2 : BaseTool
    {
        ...
        public MeasureDistanceTool2(FormMeasure form)
        {
            base.m_category = "量算";
            base.m_caption = "距离量算";
            base.m_message = "距离量算工具";
            base.m_toolTip = "距离量算工具";
            base.m_name = "MeasureDistanceTool2";
            this.mFormMeasure = form;
            try
            {
                base.m_bitmap = new Bitmap(this.GetType(), "Measure.MeasureDistance.bmp");
                base.m_cursor = new Cursor(this.GetType(), "Measure.MeasureDistance.cur");
            }
                ...
                if (this.mInUsing && (this.mFeedback != null))
                {
                    ...
                    if ((polyline != null) && !polyline.IsEmpty)
                    {
                        ...
                        else
                        {
                            ...
                            GISFunFactory.ElementFun.AddElement(pGraphicsLayer, pElement, false, false);
                            activeView.PartialRefresh(esriViewDrawPhase.esriViewGraphics, pElement, null);
                        }
                        this.mFormMeasure.SetMeasureResult(activeView, pElement, polyline, pLineSymbol);
