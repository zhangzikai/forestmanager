namespace Measure
{
    ...
    public class MeasureFeatureTool2 : BaseTool
    {
        ...
        public MeasureFeatureTool2(FormMeasure form)
        {
            base.m_category = "量算";
            base.m_caption = "要素量算";
            base.m_message = "要素量算工具";
            base.m_toolTip = "要素量算工具";
            base.m_name = "MeasureFeatureTool2";
            this.mFormMeasure = form;
            try
            {
                base.m_bitmap = new Bitmap(this.GetType(), "Measure.MeasureFeatures.bmp");
                base.m_cursor = new System.Windows.Forms.Cursor(this.GetType(), "Measure.MeasureFeatures.cur");
            }
