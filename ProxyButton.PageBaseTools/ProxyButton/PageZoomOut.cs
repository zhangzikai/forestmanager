namespace ProxyButton
{
    ...
    public sealed class PageZoomOut : BaseTool
    {
        ...
        public PageZoomOut()
        {
            ...
            base.m_message = "";
            base.m_toolTip = "缩小页面";
            base.m_name = "PageZoomOut";
            try
            {
                base.m_cursor = new Cursor(base.GetType(), "ProxyButton.Resources.PageZoomOut.cur");
            }
        ...
        public override void OnCreate(object hook)
        {
            ...
            this._tool = new ControlsPageZoomOutToolClass();
